...
kubelet_alt_names="$KUBE_KUBELET_ALT_NAMES"
...
if ! (./easyrsa --batch init-pki
      ...
      ./easyrsa --batch --subject-alt-name="$kubelet_alt_names" build-server-full apiserver-kubelet-client nopass
...
cp -p pki/issued/apiserver-kubelet-client.crt "${cert_dir}/apiserver-kubelet-client.crt"
cp -p pki/private/apiserver-kubelet-client.key "${cert_dir}/apiserver-kubelet-client.key"
cp -p pki/issued/kubecfg.crt "${cert_dir}/kubecfg.crt"
cp -p pki/private/kubecfg.key "${cert_dir}/kubecfg.key"
cp -p pki/issued/kubelet.crt "${cert_dir}/kubelet.crt"
cp -p pki/private/kubelet.key "${cert_dir}/kubelet.key"

CERTS=("ca.crt" "server.key" "server.crt" "apiserver-kubelet-client.key" "apiserver-kubelet-client.crt" "kubelet.key" "kubelet.crt" "kubecfg.key" "kubecfg.crt")
